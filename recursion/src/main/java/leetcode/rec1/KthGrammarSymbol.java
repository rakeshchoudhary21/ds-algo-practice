...
public class KthGrammarSymbol {
    ...
    /**
     * Grammar is generated recursively, and start point is 1 row 1 symbol=0, next row is by rule-> 0 becomes 0,1 and 1 becomes 1,0
     * @param n
     * @param k
     * @return
     */
    ...
    public static void main(String[] args) {
        System.out.println(kthSymbol(2,4));
    }
}
